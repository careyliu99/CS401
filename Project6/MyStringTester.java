public class MyStringTester
{
	public static void main( String[] args )
	{
		...
		MyString s2 = new MyString(s1); // copy constructor  -- s2 is the other (invoking his copy of the code), s1 is this
		System.out.println( "s2=" + s2 );
		
		if ( s1.equals( s2 ) ) // boolean method(T/F) - compareTo gives more information back 
